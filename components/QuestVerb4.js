...
export default function Materi({navigation}) {
  return(
    ...
    <View style={styles.boks1}>
      <Text style={styles.quest}>I Will ... out on Sunday</Text>
      </View>
    <TouchableOpacity style={styles.boks2} onPress={() => navigation.navigate('QuestVerb5Screen')}>
      <Text style={styles.teks2}> Go </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> Say </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> Talk </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> Read </Text>
      </TouchableOpacity>
    </View>
  )
}
