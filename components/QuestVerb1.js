...
export default function Materi({navigation}) {
  return(
    ...
    <View style={{ backgroundColor: '#A36F4A', width: 40, height: 40, borderRadius: 5, marginTop: 10, marginLeft: 220, }} > <Text style={styles.number}> 1 </Text>
      </View>
    </View>
    <View style={styles.boks1}>
      <Text style={styles.quest}>Ada berapa macam jenis verb ?</Text>
      </View>
    <TouchableOpacity style={styles.boks2} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> 1 </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('QuestVerb2Screen')}>
