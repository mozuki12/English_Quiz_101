...
export default function Materi({navigation}) {
  return(
    ...
    <View style={styles.boks1}>
      <Text style={styles.quest}>Noun adalah ?</Text>
      </View>
    <TouchableOpacity style={styles.boks2} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> Kata Sifat </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('QuestNoun2Screen')}>
      <Text style={styles.teks2}> Kata Benda </Text>
      </TouchableOpacity>
    </View>
  )
}
