...
export default function Materi({navigation}) {
  return(
    ...
    <View style={styles.boks1}>
      <Text style={styles.quest}>Manakah yang termasuk irregular verb ?</Text>
      </View>
    <TouchableOpacity style={styles.boks2} onPress={() => navigation.navigate('PeringatanScreen')}>
      <Text style={styles.teks2}> Go </Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('QuestVerb3Screen')}>
      <Text style={styles.teks2}> Went </Text>
      </TouchableOpacity>
    </View>
  )
}
