...
export default function Materi({navigation}) {
  return(
    ...
    <Text style={styles.teks1}>Select Material</Text>
    <TouchableOpacity style={styles.boks1} onPress={() => navigation.navigate('VerbMat')}>
      <Text style={styles.teks2}>Verb</Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks2} onPress={() => navigation.navigate('NounMat')}>
      <Text style={styles.teks2}>Noun</Text>
      </TouchableOpacity>
    <TouchableOpacity style={styles.boks3} onPress={() => navigation.navigate('AdjecMat')}>
